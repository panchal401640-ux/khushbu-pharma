        ...
        <div className="grid gap-12 lg:grid-cols-3">
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-lg border border-gray-200 p-5">
              ...
              <a href={"tel:" + PHONE} className="text-sm text-gray-600 hover:text-blue-600">{PHONE}</a>
            </div>
            ...
            <div className="rounded-lg border border-gray-200 p-5">
              ...
              <a href={WHATSAPP_URL()} target="_blank" rel="noopener noreferrer" className="text-sm text-gray-600 hover:text-green-600">Chat on WhatsApp</a>
            </div>
            ...
            <div className="rounded-lg border border-gray-200 p-5">
              ...
              <a href={"mailto:" + EMAIL} className="text-sm text-gray-600 hover:text-blue-600">{EMAIL}</a>
            </div>

            <div className="rounded-lg border border-gray-200 bg-gray-50 p-5">
              <h3 className="mb-2 font-semibold text-gray-900">Our Process</h3>
              <ol className="space-y-2 text-sm text-gray-600">
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-blue-600 text-[10px] font-bold text-white">4</span>
