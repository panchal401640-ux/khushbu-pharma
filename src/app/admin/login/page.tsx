    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-green-950 flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md relative">
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-green-500 to-blue-600 rounded-2xl shadow-2xl shadow-green-500/30 mb-6">
            <span className="text-white text-3xl font-black">K</span>
          </div>
          <h1 className="text-2xl font-bold text-white tracking-tight">KHUSHBU PHARMA MACHINERY</h1>
          <p className="text-sm text-green-400 mt-2 font-medium">Admin Panel</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-gray-300 rounded-xl text-sm focus:border-green-500 focus:ring-2 focus:ring-green-100 focus:outline-none transition-all"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 pr-12 border border-gray-300 rounded-xl text-sm focus:border-green-500 focus:ring-2 focus:ring-green-100 focus:outline-none transition-all"
            ...
            <button type="submit" disabled={loading || !password} className="w-full bg-gradient-to-r from-green-600 to-blue-600 text-white py-3 rounded-xl text-sm font-semibold hover:from-green-700 hover:to-blue-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-green-600/30 hover:shadow-xl">
              {loading ? (
          ...
          <div className="mt-6 pt-6 border-t border-gray-200">
            <p className="text-xs text-gray-500 text-center">
              Default credentials: <span className="font-mono bg-gray-100 px-1.5 py-0.5 rounded text-gray-600">admin</span> / <span className="font-mono bg-gray-100 px-1.5 py-0.5 rounded text-gray-600">khushbu@2024</span>
            </p>
          </div>
        </div>
      </div>
